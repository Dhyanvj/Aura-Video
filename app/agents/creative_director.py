...
given; otherwise leave bgm_file null and a random track will be used. Recommend a
voice name suited to the tone. Suggest a subtitle style. Draft a working title and
3 hook variants for the metadata."""
