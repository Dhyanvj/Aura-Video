      ...
      {open && (
        <div className="mt-3 flex flex-col gap-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="mb-1 block text-xs text-slate-400">Default duration (s)</label>
              <input
                type="number"
                min={1}
            ...
            <div>
              <label className="mb-1 block text-xs text-slate-400">Voice style</label>
              <input
            ...
            <div>
              <label className="mb-1 block text-xs text-slate-400">Subtitle theme</label>
              <input
            ...
            <div>
              <label className="mb-1 block text-xs text-slate-400">Music palette</label>
              <input
            ...
            <div>
              <label className="mb-1 block text-xs text-slate-400">Default quality preset</label>
              <select
            ...
            {template.research_required && (
              <label className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-20 rounded border border-border bg-panel px-2 py-1 text-sm text-slate-100"
                />
              </label>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <div>
              <label className="mb-1 block text-xs text-slate-400">Scriptcraft overrides (JSON)</label>
              <textarea
                ...
                rows={4}
                className="w-full rounded border border-border bg-panel px-2 py-1.5 font-mono text-xs text-slate-100"
              />
            </div>
            <div>
              <label className="mb-1 block text-xs text-slate-400">Visual strategy (JSON)</label>
              <textarea
                value={visualJson}
...
export default function Settings() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <section className="mb-6 rounded-lg border border-border bg-panel p-4">
        <h2 className="mb-1 text-sm font-semibold text-slate-200">Content types</h2>
        ...
        <div className="flex flex-col gap-2">
          ...
          {contentTypes.length === 0 && <p className="text-xs text-slate-500">Loading...</p>}
        </div>
      </section>
