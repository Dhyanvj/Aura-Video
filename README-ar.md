...
- [x] بنية **MVC** كاملة، وكود **واضح التنظيم** وسهل الصيانة، يدعم كلاً من `API` و`لوحة تحكم استوديو المحتوى`
...
#### ② الوصول إلى لوحة التحكم أو واجهة الـ API

افتح متصفحك وزر http://127.0.0.1:8080 للوحة تحكم استوديو المحتوى، أو http://0.0.0.0:8080/docs أو http://0.0.0.0:8080/redoc لتوثيق الـ API
